...
struct ContentView: View {
    ...
    @State private var editingEntry: TripcompanionEntry?
    ...
    var body: some View {
        NavigationStack {
            ...
            .navigationTitle("Roadtrip Companion Log")
            .toolbar {
...
struct EntryEditorView: View {
    ...
    var body: some View {
        NavigationStack {
            ...
            .navigationTitle(entry == nil ? "Add Companion" : "Edit Companion")
            .toolbar {
