...
final class TripcompanionUITests: XCTestCase {
    ...
    func testFreeLimitTriggersPaywall() {
        ...
        XCTAssertTrue(app.buttons["purchaseButton"].waitForExistence(timeout: 3) || app.staticTexts["Roadtrip Companion Log Pro"].waitForExistence(timeout: 3))
    }
